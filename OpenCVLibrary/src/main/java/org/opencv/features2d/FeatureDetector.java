...
public class FeatureDetector {
    ...
    //
    // C++:  void detectPeople(Mat image, vector_KeyPoint& keypoints, Mat mask = Mat())
    //

    //javadoc: javaFeatureDetector::detectPeople(image, keypoints, mask)
    ...
    //javadoc: javaFeatureDetector::detectPeople(image, keypoints)
    ...
    //
    // C++:  void detectPeople(vector_Mat images, vector_vector_KeyPoint& keypoints, vector_Mat masks = std::vector<Mat>())
    //

    //javadoc: javaFeatureDetector::detectPeople(images, keypoints, masks)
    ...
    //javadoc: javaFeatureDetector::detectPeople(images, keypoints)
