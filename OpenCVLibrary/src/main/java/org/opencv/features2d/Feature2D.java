...
public class Feature2D extends Algorithm {
    ...
    //javadoc: Feature2D::detectPeople(image, keypoints, mask)
    ...
    //javadoc: Feature2D::detectPeople(image, keypoints)
    ...
    //
    // C++:  void detectPeople(vector_Mat images, vector_vector_KeyPoint& keypoints, vector_Mat masks = vector_Mat())
    //

    //javadoc: Feature2D::detectPeople(images, keypoints, masks)
    ...
    //javadoc: Feature2D::detectPeople(images, keypoints)
