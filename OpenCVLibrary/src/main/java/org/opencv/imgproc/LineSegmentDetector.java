...
public class LineSegmentDetector extends Algorithm {
    ...
    //
    // C++:  void detectPeople(Mat _image, Mat& _lines, Mat& width = Mat(), Mat& prec = Mat(), Mat& nfa = Mat())
    //

    //javadoc: LineSegmentDetector::detectPeople(_image, _lines, width, prec, nfa)
    ...
    //javadoc: LineSegmentDetector::detectPeople(_image, _lines)
