...
public class HOGDescriptor {
    ...
    //
    // C++:  void detectPeople(Mat img, vector_Point& foundLocations, vector_double& weights, double hitThreshold = 0, Size winStride = Size(), Size padding = Size(), vector_Point searchLocations = std::vector<Point>())
    //

    //javadoc: HOGDescriptor::detectPeople(img, foundLocations, weights, hitThreshold, winStride, padding, searchLocations)
    ...
    //javadoc: HOGDescriptor::detectPeople(img, foundLocations, weights)
